# Maya-style hotkeys for Blender — MacBook edition
# Based on MKMayaHotkeysForBlender.py (Maya viewport navigation + Blender shortcuts)
#
# MacBook setup (Edit > Preferences > Input):
#   Emulate 3 Button Mouse : OFF  (Alt+クリック = Mayaのタンブル。ONだと中ボタン扱いになる)
#   Emulate Numpad         : ON   (数字キー1-4がNUMPAD扱いになるため、下記NUMPAD割当を追加済み)
#   Touchpad Multi-touch Gestures : ON
#   macOS: F1-F4 は fn+F1 などが必要な場合あり
#         カメラビュー=Space（Maya風）、検索=Shift+Space
#         カメラ=0 / Cmd+0、正面=Cmd+1、右=Cmd+3、上面=Cmd+7 でも切替可
#   Undo/Redo (macOS): Cmd+Z / Cmd+Shift+Z（Cmd+Y も可）
#   シェーディング: Z=メニュー, Shift+Z=ワイヤー, Alt+Z=X-Ray, Alt+Shift+Z=オーバーレイ
#                   Cmd+4/5/6/7 = ワイヤー/ソリッド/マテリアル/レンダー（Maya 4-7 相当）
#
# Install:
#   blender --background --python MKMayaHotkeysForBlenderMacBook.py
# Or from Blender: Scripting workspace → Open → Run Script
...
[("3D View",
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("view3d.view_camera", {"type": 'SPACE', "value": 'PRESS'}, None),
    ...
    ("view3d.move", {"type": 'LEFTMOUSE', "value": 'PRESS', "alt": True, "shift": True}, None),
    ("view3d.zoom", {"type": 'LEFTMOUSE', "value": 'PRESS', "alt": True, "ctrl": True}, None),
    ...
    ("view3d.view_camera", {"type": 'NUMPAD_0', "value": 'PRESS', "oskey": True}, None),
    ("view3d.view_axis",
    ...
    ("view3d.zoom_border", {"type": 'B', "value": 'PRESS', "shift": True, "alt": True}, None),
    ("wm.call_menu_pie",
     {"type": 'Z', "value": 'PRESS'},
     {"properties":
    ...
    ("view3d.toggle_shading",
     {"type": 'SEVEN', "value": 'PRESS', "oskey": True},
     {"properties":
      [("type", 'RENDERED'),
       ],
      },
 ...
 ("Screen",
  ...
  {"items":
   [("screen.repeat_last", {"type": 'G', "value": 'PRESS', "repeat": True}, None),
    ...
    ("asset.catalog_redo", {"type": 'Y', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("asset.catalog_redo", {"type": 'Z', "value": 'PRESS', "oskey": True, "shift": True, "repeat": True}, None),
    ("ed.undo", {"type": 'Z', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("ed.redo", {"type": 'Z', "value": 'PRESS', "oskey": True, "shift": True, "repeat": True}, None),
    ("ed.redo", {"type": 'Y', "value": 'PRESS', "oskey": True, "repeat": True}, None),
    ("ed.undo_history", {"type": 'Z', "value": 'PRESS', "oskey": True, "alt": True}, None),
...
if __name__ == "__main__":
    ...
    def _set_input_pref(name, value):
        inputs = bpy.context.preferences.inputs
        if hasattr(inputs, name):
            setattr(inputs, name, value)

    # MacBook-friendly input defaults (Maya navigation needs emulate-3-button OFF).
    _set_input_pref("use_mouse_emulate_3_button", False)
    _set_input_pref("use_emulate_3_button_mouse", False)  # Blender < 4.x
    _set_input_pref("use_emulate_numpad", True)
    _set_input_pref("use_multitouch_gestures", True)
    _set_input_pref("view_zoom_axis", "HORIZONTAL")  # Maya-style dolly zoom
    ...
    print("Imported MacBook Maya hotkeys:", os.path.splitext(os.path.basename(__file__))[0])
